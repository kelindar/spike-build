...
{
    internal class JsDocumentContext
    {
        ...
        internal JsDocumentContext DifferentFileContext(string fileContext)
        {
            // use the SAME parser and reported variable dictionary
            var documentContext = new JsDocumentContext(m_parser, Source)
            {
