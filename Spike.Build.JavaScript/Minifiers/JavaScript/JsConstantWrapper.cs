...
{
    internal class JsConstantWrapper : JsExpression
    {
        ...
        public JsPrimitiveType PrimitiveType
        {
            get;
            set;
        }
        ...
        public bool IsNumericLiteral
        {
            get
            {
                return PrimitiveType == JsPrimitiveType.Number;
            }
        }
        ...
        public bool IsBooleanLiteral
        {
            get
            {
                return PrimitiveType == JsPrimitiveType.Boolean;
            }
        }
        ...
        public bool IsOtherDecimal
        {
            get
            {
                return PrimitiveType == JsPrimitiveType.Other
                    && Value != null
        ...
        {
            var otherConstant = otherNode as JsConstantWrapper;
