...
namespace Spike.Build.Client
{
    ...
    public class Minifier
    {
        ...
        /// </summary>
        public ICollection<MinifierError> ErrorList { get { return m_errorList; } }
        private List<MinifierError> m_errorList; // = null;
        ...
        public string MinifyJavaScript(string source)
        {
            ...
            return MinifyJavaScript(source, new JsSettings());
        }
        ...
        {
            // just pass in default settings
            return MinifyStyleSheet(source, new CssSettings(), new JsSettings());
        }
        ...
        {
            // just pass in default settings
            return MinifyStyleSheet(source, settings, new JsSettings());
        }
