...
namespace ICSharpCode.SharpZipLib.Zip
{
	...
	public class ZipEntry : ICloneable
	{
		...
		/// <summary>
		/// Gets or sets the time of last modification of the entry.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Gets or sets the crc of the uncompressed data.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the compression method. Only Deflated and Stored are supported.
		/// </summary>
		/// <returns>
