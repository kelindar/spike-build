...
namespace Spike.Build.Minifiers
{
    ...
    /// Output mode setting
    /// </summary>
    public enum MinifierOutputMode
    {
        /// <summary>
    ...
    /// </summary>
    public enum MinifierBlockStart
    {
        /// <summary>
    ...
    /// </summary>
    public class MinifierSettings
    {
        /// <summary>
        /// Constructs a new instance of <see cref="MinifierSettings"/>.
        /// </summary>
        protected MinifierSettings()
        {
            // defaults
            IndentSize = 4;
            OutputMode = MinifierOutputMode.SingleLine;
            ...
            ResourceStrings = new List<MinifierResourceStrings>();
        }
        ...
        /// </summary>
        public MinifierBlockStart BlocksStartOnSameLine
        {
            get;
            set;
        }
        ...
        /// </summary>
        public MinifierOutputMode OutputMode
        {
            get;
            set;
        }
        ...
        public string LineTerminator
        {
            get
            {
                return OutputMode == MinifierOutputMode.MultipleLines ? "\r\n" : "\n";
            }
        }
        ...
        /// </summary>
        public IList<MinifierResourceStrings> ResourceStrings { get; private set; }

        /// <summary>
        /// Adds a resource strings to the collection.
        /// </summary>
        /// <param name="resourceStrings">The resource strings to add.</param>
        public void AddResourceStrings(MinifierResourceStrings resourceStrings)
        {
            // add it
        ...
        public void AddResourceStrings(IEnumerable<MinifierResourceStrings> collection)
        {
        ...
        public void RemoveResourceStrings(MinifierResourceStrings resourceStrings)
        {
            // remove it
