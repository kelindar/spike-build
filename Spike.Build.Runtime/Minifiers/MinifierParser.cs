...
{
    internal class MinifierInvalidSwitchEventArgs : EventArgs
    {
        public string SwitchPart { get; set; }
        public string ParameterPart { get; set; }
    }

    internal class MinifierUnknownParameterEventArgs : EventArgs
    {
        ...
        public MinifierUnknownParameterEventArgs(IList<string> arguments)
        {
            Arguments = arguments;
        }
    }

    internal class MinifierParser
    {
        ...
        /// </summary>
        public JsSettings JSSettings { get; private set; }
        ...
        public event EventHandler<MinifierInvalidSwitchEventArgs> InvalidSwitch;
        public event EventHandler<MinifierUnknownParameterEventArgs> UnknownParameter;
        ...
        public MinifierParser Clone()
        {
            // clone the settings
            var newParser = new MinifierParser(this.JSSettings.Clone(), this.CssSettings.Clone());
                      ...
                      || (!m_isMono && thisArg.StartsWith("/", StringComparison.Ordinal))))
                    {
                        ...
                        switch (switchPart)
                        {
                            ...
                            case "BRACES":
                                if (paramPartUpper == "NEW")
                                {
                                    JSSettings.BlocksStartOnSameLine = 
                                        CssSettings.BlocksStartOnSameLine = MinifierBlockStart.NewLine;
                                }
                                else if (paramPartUpper == "SAME")
                                {
                                    JSSettings.BlocksStartOnSameLine =
                                        CssSettings.BlocksStartOnSameLine = MinifierBlockStart.SameLine;
                                }
                                else if (paramPartUpper == "SOURCE")
                                {
                                    JSSettings.BlocksStartOnSameLine =
                                        CssSettings.BlocksStartOnSameLine = MinifierBlockStart.UseSource;
                                }
                                else
                                {
                                    OnInvalidSwitch(switchPart, paramPart);
                            ...
                            case "EVALS":
                                ...
                                {
                                    JSSettings.EvalTreatment = JsEvalTreatment.Ignore;
                                }
                                else if (paramPartUpper == "IMMEDIATE")
                                {
                                    JSSettings.EvalTreatment = JsEvalTreatment.MakeImmediateSafe;
                                }
                                else if (paramPartUpper == "SAFEALL")
                                {
                                    JSSettings.EvalTreatment = JsEvalTreatment.MakeAllSafe;
                                }
                                else
                                {
                                    OnInvalidSwitch(switchPart, paramPart);
                            ...
                            case "JS":
                                ...
                                {
                                    // normal settings
                                    JSSettings.SourceMode = JsSourceMode.Program;
                                    JSSettings.Format = JsFormat.Normal;
                                }
                                else
                                {
                                    ...
                                    foreach (var token in tokens)
                                    {
                                        switch (token)
                                        {
                                            case "JSON":
                                                ...
                                                JSSettings.SourceMode = JsSourceMode.Expression;
                                                JSSettings.Format = JsFormat.JSON;
                                                break;
                                            ...
                                            case "EVT":
                                                JSSettings.SourceMode = JsSourceMode.EventHandler;
                                                break;
                            ...
                            case "LINES":
                                if (string.IsNullOrEmpty(paramPartUpper))
                                {
                                    ...
                                    JSSettings.OutputMode = 
                                        CssSettings.OutputMode = MinifierOutputMode.SingleLine;
                                    ...
                                    if (lineParts.Length <= 3)
                                    {
                                        ...
                                        if (!string.IsNullOrEmpty(lineParts[0]))
                                        {
                                            ...
                                            else if (lineParts[0][0] == 'M')
                                            {
                                                // multiple-line mode
                                                JSSettings.OutputMode =
                                                    CssSettings.OutputMode = MinifierOutputMode.MultipleLines;
                            ...
                            case "MINIFY":
                                ...
                                if (renamingSpecified && JSSettings.LocalRenaming != JsLocalRenaming.KeepAll)
                                {
                            ...
                            case "P": // <-- old style
                                ...
                                JSSettings.OutputMode = CssSettings.OutputMode = MinifierOutputMode.MultipleLines;
                                CssSettings.KillSwitch = ~((long)JsTreeModifications.PreserveImportantComments);
                            ...
                            case "RENAME":
                                ...
                                else
                                {
                                    ...
                                    {
                                        JSSettings.LocalRenaming = JsLocalRenaming.CrunchAll;
                                    ...
                                    {
                                        JSSettings.LocalRenaming = JsLocalRenaming.KeepLocalizationVars;
                                    ...
                                    {
                                        JSSettings.LocalRenaming = JsLocalRenaming.KeepAll;
                                ...
                                if (JSSettings.LocalRenaming != JsLocalRenaming.KeepAll)
                                {
        ...
        protected virtual int OnUnknownParameter(IList<string> arguments, int index, string switchPart, string parameterPart)
        {
            if (UnknownParameter != null)
            {
                ...
                var ea = new MinifierUnknownParameterEventArgs(arguments)
                {
                    Index = index,
        ...
        protected virtual void OnInvalidSwitch(string switchPart, string parameterPart)
        {
            ...
            {
                InvalidSwitch(this, new MinifierInvalidSwitchEventArgs() { SwitchPart = switchPart, ParameterPart = parameterPart });
            }
        }
        ...
        private void ResetRenamingKill(bool killSpecified)
        {
            ...
            {
                JSSettings.KillSwitch &= ~((long)JsTreeModifications.LocalRenaming);
            }
        }
