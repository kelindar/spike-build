...
namespace Spike.Build.Minifiers
{
    ...
    internal abstract class JsDeclaration : JsAstNode, IEnumerable<JsVariableDeclaration>
    {
        private List<JsVariableDeclaration> m_list;
        ...
        public JsVariableDeclaration this[int index]
        {
        ...
        public JsActivationObject Scope { get; set; }
        ...
        internal void Append(JsAstNode elem)
        {
            JsVariableDeclaration decl = elem as JsVariableDeclaration;
            if (decl != null)
            {
            ...
            else
            {
                ...
                var otherVar = elem as JsDeclaration;
                if (otherVar != null)
                {
        ...
        internal void InsertAt(int index, JsAstNode elem)
        {
            JsVariableDeclaration decl = elem as JsVariableDeclaration;
            if (decl != null)
            {
        ...
        private bool HandleDuplicates(string name)
        {
            ...
            {
                JsVariableDeclaration varDecl = m_list[ndx];
        ...
        public void Remove(JsVariableDeclaration variableDeclaration)
        {
        ...
        public IEnumerator<JsVariableDeclaration> GetEnumerator()
        {
