...
{
    internal sealed class JsFunctionScope : JsActivationObject
    {
        public JsFunctionObject FunctionObject { get; private set; }

        private HashSet<JsActivationObject> m_refScopes;
        ...
        private void DefineArgumentsObject()
        {
            ...
            if (this[name] == null)
            {
                this.AddField(new JsVariableField(JsFieldType.Arguments, name, 0, null));
            }
        }
