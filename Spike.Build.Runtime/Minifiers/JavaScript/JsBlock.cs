...
namespace Spike.Build.Minifiers
{
    ...
    internal sealed class JsBlock : JsAstNode
    {
        ...
        private JsBlockScope m_blockScope;
        internal JsBlockScope BlockScope
        {
        ...
        internal override bool IsDebuggerStatement
        {
            get
            {
                ...
                foreach (JsAstNode statement in m_list)
                {
        ...
        public void InsertRange(int index, IEnumerable<JsAstNode> newItems)
        {
            if (newItems != null)
            {
                m_list.InsertRange(index, newItems);
                foreach (JsAstNode newItem in newItems)
                {
                    newItem.Parent = this;
                }
            }
