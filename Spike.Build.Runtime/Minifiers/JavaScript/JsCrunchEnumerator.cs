...
{
    internal class JsCrunchEnumerator
    {
        ...
        internal JsCrunchEnumerator(IEnumerable<string> avoidNames)
        {
    ...
    internal class ReferenceComparer : IComparer<JsVariableField>
    {
        ...
        public int Compare(JsVariableField left, JsVariableField right)
        {
            ...
            */
            ...
            if ((left.FieldType == JsFieldType.Argument || left.FieldType == JsFieldType.CatchError)
                && (right.FieldType == JsFieldType.Argument || right.FieldType == JsFieldType.CatchError))
            {
            ...
            if (right.FieldType == JsFieldType.Argument || right.FieldType == JsFieldType.CatchError)
            {
                return 1;
            }
