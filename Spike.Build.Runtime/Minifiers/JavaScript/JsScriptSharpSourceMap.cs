...
{
    internal sealed class JsScriptSharpSourceMap : IJsSourceMap
    {
        ...
        public JsScriptSharpSourceMap(TextWriter writer)
        {
            if (writer == null)
            {
        ...
        public object StartSymbol(JsAstNode node, int startLine, int startColumn)
        {
            if (node != null 
        ...
        private class JavaScriptSymbol
        {
            ...
            private JsContext m_sourceContext;
