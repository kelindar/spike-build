...
namespace Spike.Build.Minifiers
{
    ...
    /// </summary>
    internal class JsResolutionVisitor : IJsVisitor
    {
        ...
        private Stack<JsActivationObject> m_lexicalStack;

        /// <summary>stack to maintain the current variable scope as we traverse the tree</summary>
        private Stack<JsActivationObject> m_variableStack;
        ...
        private JsActivationObject CurrentLexicalScope
        {
            get
            {
        ...
        private JsActivationObject CurrentVariableScope
        {
            get
            {
        ...
        public void Visit(JsForIn node)
        {
            if (node != null)
            {
                ...
                if (node.Variable != null)
                {
                    ...
                    var lexDeclaration = node.Variable as JsLexicalDeclaration;
