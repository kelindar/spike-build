...
{
    internal sealed class JsCallNode : JsExpression
    {
        private JsAstNode m_function;
        private JsAstNodeList m_arguments;

        public JsAstNode Function
        {
        ...
        public JsAstNodeList Arguments
        {
        ...
        public JsCallNode(JsContext context, JsParser parser)
            : base(context, parser)
        {
        }
        ...
        public override JsOperatorPrecedence Precedence
        {
            get
            {
                ...
                return /*IsConstructor ? OperatorPrecedence.Unary :*/ JsOperatorPrecedence.FieldAccess;
            }
        }
        ...
        public override bool IsExpression
        {
            get
            {
                ...
                // get combined.
                JsMember callMember = Function as JsMember;
                if (callMember != null
        ...
        internal override bool IsDebuggerStatement
        {
            get
            {
                ...
                return ((Function is JsMember || Function is JsCallNode || Function is JsLookup) && Function.IsDebuggerStatement);
            }
        }
    }
}