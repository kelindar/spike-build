...
namespace Spike.Build.Minifiers
{
    internal sealed class JsScanner
    {
        ...
        private static readonly JsOperatorPrecedence[] s_OperatorsPrec = InitOperatorsPrec();
        ...
        public event EventHandler<JsGlobalDefineEventArgs> GlobalDefine;

        public event EventHandler<JsNewModuleEventArgs> NewModule;

        #endregion

        #region constructors

        public JsScanner(JsContext sourceContext)
        {
        ...
        public JsContext ScanNextToken(bool scanForRegularExpressionLiterals)
        {
        ...
        private void OnGlobalDefine(string name)
        {
            ...
            {
                GlobalDefine(this, new JsGlobalDefineEventArgs() { Name = name });
            }
        }
        ...
        private void OnNewModule(string newModule)
        {
            if (NewModule != null)
            {
                NewModule(this, new JsNewModuleEventArgs { Module = newModule });
            }
        }
        ...
        internal static JsOperatorPrecedence GetOperatorPrecedence(JsContext op)
        {
            return op == null || op.Token == JsToken.None ? JsOperatorPrecedence.None : JsScanner.s_OperatorsPrec[op.Token - JsToken.FirstBinaryOperator];
        }
        ...
        private static JsOperatorPrecedence[] InitOperatorsPrec()
        {
            JsOperatorPrecedence[] operatorsPrec = new JsOperatorPrecedence[JsToken.LastOperator - JsToken.FirstBinaryOperator + 1];

            operatorsPrec[JsToken.Plus - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Additive;
            operatorsPrec[JsToken.Minus - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Additive;

            operatorsPrec[JsToken.LogicalOr - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.LogicalOr;
            operatorsPrec[JsToken.LogicalAnd - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.LogicalAnd;
            operatorsPrec[JsToken.BitwiseOr - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.BitwiseOr;
            operatorsPrec[JsToken.BitwiseXor - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.BitwiseXor;
            operatorsPrec[JsToken.BitwiseAnd - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.BitwiseAnd;

            operatorsPrec[JsToken.Equal - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Equality;
            operatorsPrec[JsToken.NotEqual - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Equality;
            operatorsPrec[JsToken.StrictEqual - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Equality;
            operatorsPrec[JsToken.StrictNotEqual - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Equality;

            operatorsPrec[JsToken.InstanceOf - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Relational;
            operatorsPrec[JsToken.In - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Relational;
            operatorsPrec[JsToken.GreaterThan - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Relational;
            operatorsPrec[JsToken.LessThan - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Relational;
            operatorsPrec[JsToken.LessThanEqual - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Relational;
            operatorsPrec[JsToken.GreaterThanEqual - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Relational;

            operatorsPrec[JsToken.LeftShift - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Shift;
            operatorsPrec[JsToken.RightShift - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Shift;
            operatorsPrec[JsToken.UnsignedRightShift - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Shift;

            operatorsPrec[JsToken.Multiply - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Multiplicative;
            operatorsPrec[JsToken.Divide - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Multiplicative;
            operatorsPrec[JsToken.Modulo - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Multiplicative;

            operatorsPrec[JsToken.Assign - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Assignment;
            operatorsPrec[JsToken.PlusAssign - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Assignment;
            operatorsPrec[JsToken.MinusAssign - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Assignment;
            operatorsPrec[JsToken.MultiplyAssign - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Assignment;
            operatorsPrec[JsToken.DivideAssign - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Assignment;
            operatorsPrec[JsToken.BitwiseAndAssign - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Assignment;
            operatorsPrec[JsToken.BitwiseOrAssign - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Assignment;
            operatorsPrec[JsToken.BitwiseXorAssign - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Assignment;
            operatorsPrec[JsToken.ModuloAssign - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Assignment;
            operatorsPrec[JsToken.LeftShiftAssign - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Assignment;
            operatorsPrec[JsToken.RightShiftAssign - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Assignment;
            operatorsPrec[JsToken.UnsignedRightShiftAssign - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Assignment;

            operatorsPrec[JsToken.ConditionalIf - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Conditional;
            operatorsPrec[JsToken.Colon - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Conditional;

            operatorsPrec[JsToken.Comma - JsToken.FirstBinaryOperator] = JsOperatorPrecedence.Comma;
    ...
    internal class JsGlobalDefineEventArgs : EventArgs
    {
        public string Name { get; set; }
    }

    internal class JsNewModuleEventArgs : EventArgs
    {
