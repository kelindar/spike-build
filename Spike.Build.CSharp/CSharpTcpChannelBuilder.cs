...
{
    public class CSharpTcpChannelBuilder
    {
        /// <summary>
        ...
        public static void GenerateCode(CSharpBuilder builder)
        {
            using (var writer = new CodeWriter())
            {
                ...
                builder.AddSourceFile(builder.SrcOutputPath, @"TcpChannel.cs", writer);
            }
        }
        ...
        internal static void GenerateServerChannel(CSharpBuilder builder, TextWriter writer)
        {
            ...
            writer.WriteLine("public class TcpChannel : TcpChannelBase"); // Begin class
            writer.WriteLine("{");
            {
        ...
        {
            writer.WriteLine("public TcpChannel() : base()"); 
            writer.WriteLine("{");
        ...
        internal static void GeneratePropertiesAndFields(CSharpBuilder builder, TextWriter writer)
        {
            ...
            writer.WriteLine("/// was issued (flag applies for pull operations only)");
            writer.WriteLine("/// </summary>");
